...
def write_files_tsv(md, basepath, target_path, import_type='flat'):
...
def write_import_yml(basepath, target_path):
    ...
    import_yml_path = basepath + '/import.yml'
...
def write_import_md_json(md, basepath, user, group):
    ...
    import_md_path = basepath + '/import_md.json'
    ...
    md_json['import_batch_path'] = basepath
